...
/**
 * Represents a region of an unspecified shape in the world Credits to Redempt with Redlib.
 */
...
public abstract class Region implements Cloneable {
   ...
   * @return Itself
   */
  public abstract Region expand(double posX, double negX, double posY, double negY, double posZ,
      double negZ);
   ...
   *
   * @param direction The BlockFace representing the axis - opposites will act the same (i.e. UP,
   *                  DOWN)
    ...
    switch (direction) {
      ...
      default:
        throw new IllegalArgumentException(
            "Face must be one of UP, DOWN, NORTH, SOUTH, EAST, or WEST");
    }
  }

package me.untouchedodin0.privatemines.utils.task;
...
public class Task {
    ...
    public static Task syncDelayed(Runnable run) {
        return syncDelayed(PrivateMines.getCallingPlugin(), run);
    }
    ...
    public static Task syncDelayed(Runnable run, long delay) {
        return syncDelayed(PrivateMines.getCallingPlugin(), run, delay);
    }
    ...
    public static Task syncRepeating(Runnable run, long delay, long period) {
        return syncRepeating(PrivateMines.getCallingPlugin(), run, delay, period);
    }
    ...
    public static Task asyncDelayed(Runnable run) {
        return asyncDelayed(PrivateMines.getCallingPlugin(), run);
    }
    ...
    public static Task asyncDelayed(Runnable run, long delay) {
        return asyncDelayed(PrivateMines.getCallingPlugin(), run, delay);
    }
    ...
    public static Task asyncRepeating(Consumer<Task> run, long delay, long period) {
        return asyncRepeating(PrivateMines.getCallingPlugin(), run, delay, period);
    }

...
public class ConversionUtils {
    ...
    public static void convertToSQL(Path path) {
...
//        Bukkit.broadcastMessage("yamlMatcher: " + yamlMatcher);
//        Bukkit.broadcastMessage("sqlHelper: " + sqlHelper);

        CompletableFuture.runAsync(() -> {
            try (Stream<Path> paths = Files.walk(path).filter(yamlMatcher::matches)) {
